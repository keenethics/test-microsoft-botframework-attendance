...
bot.dialog('/menu', new builder.IntentDialog()
    ...
    .matches(/^help/i,builder.DialogAction.send('You can : 1. day off  2.createAlarm  3.editprofile 4.full info 5.vacation') )
    ...
    .onDefault(builder.DialogAction.send('You can : 1. day off  2.createAlarm  3.editprofile 4.full info 5. vacation '))
