...
const adminOptions = 'You can : 1. day off 2. editprofile 3.full info 4. user info 5.change info 6.vacation 7.active events 8. confirm events 9. settings 10. user status';
